...
#create Table
CREATE OR REPLACE EXTERNAL TABLE `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.emergency_calls`
OPTIONS (
  format = 'CSV',
...
%%bigquery
CREATE OR REPLACE TABLE `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.emergency_calls_encoded` AS(
  SELECT
  * EXCEPT (
  ...
  -- traffic_level
   ...
   FROM `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.emergency_calls`
...
CREATE or REPLACE MODEL `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.response_time_model`
OPTIONS(
    model_type='LINEAR_REG',
    input_label_cols=['response_time']) AS
SELECT * FROM  `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.emergency_calls_encoded`
...
SELECT * FROM ML.EVALUATE(
  MODEL `qwiklabs-gcp-02-0b35817aba3e.emergency_calls_dataset.response_time_model`
)
